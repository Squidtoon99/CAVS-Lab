...
#include "cpm/dds/VehicleObservationPubSubTypes.hpp"
#include "cpm/dds/VehicleCommandDirectPubSubTypes.hpp"
#include "cpm/dds/VehicleCommandSpeedCurvaturePubSubTypes.hpp"
#include "cpm/dds/VehicleCommandTrajectoryPubSubTypes.hpp"
#include "cpm/dds/VehicleStatePubSubTypes.hpp"
...
int main(int argc, char *argv[])
{
    ...
    writer_vehicleState.max_blocking(eprosima::fastdds::dds::Time_t(0,MAX_BLOCKING_NS));
    ...
    reader_vehicleObservation->max_blocking(eprosima::fastdds::dds::Time_t(0,MAX_BLOCKING_NS));
    ...
    update_loop->start(
        ...
        [&](uint64_t t_now) 
        {
            ...
            try 
            {
                ...
                cpm::TimeMeasurement::Instance().start("pwm");
                spi_transfer(
                    spi_mosi_data,
                    &spi_miso_data,
                ...
                cpm::TimeMeasurement::Instance().stop("pwm");
